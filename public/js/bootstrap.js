...
!function (t) {
    ...
    function i(i) {
        return this.each(function () {
            var o = t(this), n = o.data("bs.button"), s = "object" == typeof i && i;
    ...
    e.VERSION = "3.3.7", e.TRANSITION_DURATION = 600, e.DEFAULTS = {
        ...
        var n = this.$element.find(".item.active"), s = o || this.getItemForDirection(i, n), a = this.interval,
            r = "next" == i ? "left" : "right", l = this;
    ...
    t.fn.collapse = o, t.fn.collapse.Constructor = e, t.fn.collapse.noConflict = function () {
        ...
        var s = i(n), a = s.data("bs.collapse") ? "toggle" : n.data();
        o.call(s, a)
    })
}(jQuery), function (t) {
    "use strict";
    var e = ".dropdown-backdrop", i = '[data-toggle="dropdown"]', o = function (e) {
    ...
    function s(o) {
        o && 3 === o.which || (t(e).remove(), t(i).each(function () {
            var e = t(this), i = n(e), s = {relatedTarget: this};
    ...
    o.VERSION = "3.3.7", o.prototype.toggle = function (e) {
        var i = t(this);
    ...
    function i(i, o) {
        return this.each(function () {
            var n = t(this), s = n.data("bs.modal"), a = t.extend({}, e.DEFAULTS, n.data(), "object" == typeof i && i);
    ...
    e.VERSION = "3.3.7", e.TRANSITION_DURATION = 300, e.BACKDROP_TRANSITION_DURATION = 150, e.DEFAULTS = {
        ...
        var o = this, n = t.Event("show.bs.modal", {relatedTarget: i});
    ...
    e.VERSION = "3.3.7", e.TRANSITION_DURATION = 150, e.DEFAULTS = {
        ...
        if (this.$element.trigger(s), !s.isDefaultPrevented()) return n.removeClass("in"), t.support.transition && n.hasClass("fade") ? n.one("bsTransitionEnd", a).emulateTransitionEnd(e.TRANSITION_DURATION) : a(), this.hoverState = null, this
    ...
    function i(i) {
        return this.each(function () {
            var o = t(this), n = o.data("bs.affix"), s = "object" == typeof i && i;
    ...
    e.VERSION = "3.3.7", e.RESET = "affix affix-top affix-bottom", e.DEFAULTS = {
        ...
        if (this.$element.is(":visible")) {
            var i = this.$element.height(), o = this.options.offset, n = o.top, s = o.bottom,
