                        ...
                        <div class="row">
                            <div class="col-xl-12 col-lg-12 col-md-12 col-sm-12 col-12">
                                ...
                                <div class="card">
                                    ...
                                    <h3 class="section-title">Editar arquivo de transparência - Administrativo</h3>
                                    <p>Use este formulário para editar o arquivo de administrativo.</p>
                                        <form action="{{ route('painel.editado.transparencia.administrativo') }}" method="post" enctype="multipart/form-data" accept-charset="UTF-8"  autocomplete="off">                                        <div class="card-body">
                                            @csrf
