                                            ...
                                            <table id="example" class="display" style="width:100%;">
                                                ...
                                                <tbody>
                                                    ...
                                                    <tr>
                                                        ...
                                                        <td><a href="{{ route('painel.editar.transparencia.administrativo', ['id' => $arquivo->id]) }}" class="btn btn-primary" type="submit">Editar</a></td>
                                                        <td><a href="{{ route('painel.delete.transparencia.administrativo', ['id' => $arquivo->id]) }}" type="button" class="btn btn-danger">excluir</a></td>
                                                    </tr>
                                                    @endforeach
                                                </tbody>
                                                <tfoot>
