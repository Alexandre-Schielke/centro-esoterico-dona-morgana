                                ...
                                <div class="card">
                                    <div class="card-body">
                                        <div class="metric-label d-inline-block text-success font-weight-bold">
                                            <a href="{{ route('painel.transparencia.administrativo') }}" class="btn btn-primary">Listar arquivo</a>
                                        </div>
                                    </div>
                                </div>
                            </div>
                        ...
                        <div class="row">
                            <div class="col-xl-12 col-lg-12 col-md-12 col-sm-12 col-12">
                                ...
                                <div class="card">
                                    ...
                                    <h3 class="section-title">Adicionar arquivo de transparência - Administrativo</h3>
                                    <p>Use este formulário para adicionar um novo arquivo de transparência.</p>
                                        <form action="{{ route('painel.store.transparencia.administrativo') }}" method="post" enctype="multipart/form-data" accept-charset="UTF-8"  autocomplete="off">                                        <div class="card-body">
                                            @csrf
                                            ...
                                            <div class="form-group">
                                                <label for="arquivo_categoria_id" class="col-form-label">Categoria do arquivo</label>
